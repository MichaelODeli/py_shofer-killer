...
layoutParam = [
    ...
    [sg.Text('Координаты шофера X - '), sg.Input(size=5, default_text='5'), sg.Text('Y - '), sg.Input(size=5, default_text='5'), sg.Text('Скорость шофера (до 20)'), sg.Input(size=5, default_text='20')],
    [sg.Text('Координаты пешехода X - '), sg.Input(size=5, default_text='5'), sg.Text('Y - '), sg.Input(size=5, default_text='5'), sg.Text('Скорость пешехода (до 20)'), sg.Input(size=5, default_text='10')],
